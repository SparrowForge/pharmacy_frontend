        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-wrap gap-3">
              <Badge variant="secondary" className="px-3 py-1.5 text-xs font-medium bg-primary/10 text-primary border-primary/20 hover:bg-primary/15">
                <Sparkles className="w-3 h-3 mr-1.5" />
                AI Enabled
              </Badge>
              <Badge variant="secondary" className="px-3 py-1.5 text-xs font-medium bg-secondary text-secondary-foreground">
            ...
            <div className="space-y-4">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-xl text-pretty leading-relaxed">
                Manage inventory, sales, prescriptions, and delivery — all in one powerful SaaS platform designed for modern pharmacies.
              </p>
            </div>

            {/* CTA Buttons */}
            <div className="flex flex-col sm:flex-row gap-4">
              <Button size="lg" asChild className="bg-primary hover:bg-primary/90 text-lg px-8 h-14 shadow-lg shadow-primary/20">
                <Link href="/signup">
                  Get Started Free
                  ...
                  {[
                    ...
                    <div key={i} className="flex items-center justify-between p-3 rounded-lg bg-muted/30 border border-border/50">
                      ...
                      <div className="flex items-center gap-3">
                        <span className="text-xs text-muted-foreground">{item.qty} units</span>
