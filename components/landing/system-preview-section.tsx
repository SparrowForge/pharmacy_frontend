...
const tabs = [
  {
    ...
    label: "Dashboard",
    description: "Get a bird's-eye view of your pharmacy operations with real-time KPIs and insights.",
  },
  {
    id: "pos",
    icon: ShoppingCart,
    label: "POS System",
    description: "Lightning-fast checkout with smart search, barcode scanning, and one-click actions.",
  },
  {
    id: "inventory",
    icon: Package,
    label: "Inventory",
    description: "Complete inventory management with batch tracking, expiry alerts, and auto-reorder.",
  },
  {
    id: "reports",
    icon: FileBarChart,
    label: "Reports",
    description: "Comprehensive analytics with customizable reports and export options.",
  },
]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <p className="text-lg text-muted-foreground text-pretty">
            Every screen is optimized for pharmacy workflows, reducing clicks and maximizing efficiency.
          </p>
        </div>
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-4 gap-4">
        {[
          ...
          <div key={i} className="p-4 rounded-xl bg-gradient-to-br from-primary/10 to-primary/5 border border-primary/10">
      ...
      <div className="grid grid-cols-3 gap-6">
        ...
        <div className="p-6 rounded-xl border border-border">
          ...
          <div className="space-y-2">
            {["New Sale", "Add Medicine", "New Order", "Add Customer"].map((action, i) => (
              <button key={i} className="w-full p-3 text-left text-sm rounded-lg bg-muted/50 hover:bg-muted flex items-center justify-between group">
                {action}
      ...
      <div className="col-span-3 space-y-4">
        ...
        <div className="space-y-2">
          {[
            ...
            <div key={i} className="p-3 rounded-lg border border-border hover:border-primary/30 hover:bg-primary/5 cursor-pointer flex items-center justify-between">
              <div>
      ...
      <div className="col-span-2 p-4 rounded-xl bg-muted/30 border border-border flex flex-col">
        ...
        <div className="flex-1 space-y-2 overflow-auto">
          {[
            ...
            <div key={i} className="p-2 rounded bg-card border border-border text-sm flex justify-between">
      ...
      <div className="rounded-lg border border-border overflow-hidden">
        <table className="w-full">
          ...
          <tbody className="divide-y divide-border">
            {[
              { name: "Amoxicillin 500mg", batch: "AMX-2024-001", expiry: "Dec 2025", stock: 450, status: "In Stock" },
              { name: "Paracetamol 650mg", batch: "PCM-2024-015", expiry: "Mar 2025", stock: 23, status: "Low Stock" },
              { name: "Cetirizine 10mg", batch: "CTZ-2024-008", expiry: "Jun 2025", stock: 180, status: "In Stock" },
              { name: "Vitamin D3", batch: "VTD-2024-022", expiry: "Jan 2025", stock: 8, status: "Expiring" },
            ].map((item, i) => (
