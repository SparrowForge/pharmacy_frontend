...
const medicines = [
  { id: 1, name: "Paracetamol 500mg", price: 2.50, stock: 450 },
  { id: 2, name: "Amoxicillin 500mg", price: 5.00, stock: 23 },
  { id: 3, name: "Cetirizine 10mg", price: 2.50, stock: 180 },
  { id: 4, name: "Omeprazole 20mg", price: 5.00, stock: 95 },
  { id: 5, name: "Vitamin D3 1000IU", price: 5.00, stock: 8 },
]
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card className="border-border">
              <CardHeader>
                ...
                <CardDescription>Select or add customer information</CardDescription>
              </CardHeader>
            ...
            <Card className="border-border">
              <CardHeader>
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <CardDescription>Add medicines to the order</CardDescription>
                  </div>
              ...
              <CardContent className="space-y-4">
                {orderItems.map((item, index) => (
                  <div key={index} className="flex items-end gap-4 p-4 rounded-lg bg-muted/50 border border-border">
                    <div className="flex-1 space-y-2">
                      <Label>Medicine</Label>
                      <Select 
                        value={item.medicineId}
                        onValueChange={(value) => updateItem(index, "medicineId", value)}
                      >
                        <SelectTrigger>
                        ...
                        <SelectContent>
                          {medicines.map((med) => (
                            <SelectItem key={med.id} value={med.id.toString()}>
                              {med.name} - ${med.price.toFixed(2)} ({med.stock} in stock)
                            </SelectItem>
                          ))}
                        </SelectContent>
                      </Select>
          ...
          <div className="space-y-6">
            ...
            <Card className="border-border">
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  {orderItems.filter(item => item.medicineId).map((item, index) => {
