...
import { ICreateShopPayload, IDeleteShopResponse, IGetShopsQuery, IShop, IShopResponse, IUpdateShopPayload } from "@/src/types/shop.types";
...
const deleteShopService = async (id: string): Promise<IDeleteShopResponse> => {
