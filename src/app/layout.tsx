...
export const metadata: Metadata = {
  ...
  description:
    "Manage inventory, sales, prescriptions, and delivery with our intelligent SaaS platform designed for modern pharmacies.",
  keywords: [
    "pharmacy management",
    "POS system",
  ...
  openGraph: {
    ...
    description:
      "The complete pharmacy management solution with AI-powered insights.",
    type: "website",
  },
};
