              ...
              <div className="flex items-center justify-between p-4 rounded-lg bg-muted">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Display payment QR code on invoices
                  </p>
                </div>
              ...
              <div className="space-y-4">
                {[
                  ...
                  },
                  {
                    ...
                    description:
                      "Receive alerts for medicines expiring within 30 days",
                    default: true,
                  },
                  {
                    title: "New Order Notifications",
                    description: "Alert when new orders are placed",
                    default: true,
                  },
                  {
                    title: "Daily Sales Summary",
                    description: "Receive daily sales report via email",
                    default: false,
                  },
                  {
                    title: "AI Insights",
                    description:
                      "Get notified about AI predictions and suggestions",
                    default: true,
                  },
                  {
