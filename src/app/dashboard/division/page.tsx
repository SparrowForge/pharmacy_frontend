...
import DivisionDialogueForm from "@/src/components/division/DivisionDialogueForm";
...
export default function DivisionsPage() {
  ...
  const { fetchDivisions, deleteDivision } = useDivisions();

  const { divisions, fetchLoading } = useAppSelector(
  ...
  }, [fetchDivisions, page, limit, search, includeDeleted]);
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-muted-foreground">Manage all divisions</p>
          </div>
        </div>

        <DivisionDialogueForm
                ...
                {divisions.length > 0 &&
                  divisions.map((division) => (
                    <TableRow key={division.id}>
                      ...
                      <TableCell>{division.country_id}</TableCell>
                      ...
                      <TableCell className="text-right">
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end">
                            <DropdownMenuItem
                              onClick={() => setEditDivisionId(division.id)}
                            >
