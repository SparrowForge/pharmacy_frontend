...
import { useCustomerPaymentReport } from "@/src/hooks/useCustomerPaymentReport";
...
export default function CustomerPaymentReportPage() {
  const { fetchCustomerPayments, fetchLoading, data, total_amount } =
  ...
  return (
    <div className="space-y-6">
      {/* HEADER */}
      <div>
        <h1 className="text-2xl font-semibold">Customer Payment Report</h1>
        <p className="text-muted-foreground">
          View and filter customer payments by date, customer, and payment
          method.
        </p>
      </div>
