...
const predictions = [
  {
    ...
    description:
      "Vitamin C and flu medicines will see 40% increased demand next week due to seasonal trends.",
    confidence: 92,
    action: "Order Now",
    icon: TrendingUp,
  ...
  },
  {
    ...
    description:
      "Amoxicillin 500mg may run out in 5 days based on current sales velocity.",
    confidence: 88,
    action: "Reorder",
    icon: AlertTriangle,
  ...
  },
  {
    ...
    description:
      "8 products worth $450 will expire within 30 days. Consider promotional pricing.",
    confidence: 100,
    action: "View Items",
    icon: Clock,
    color: "text-red-500",
  },
  {
    ...
    description:
      "Customers who buy Paracetamol often buy Vitamin C together. Create a bundle for 15% more sales.",
    confidence: 85,
    ...
    <div className="space-y-6">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {insights.map((insight, index) => (
          <Card
            key={index}
            className="border-border bg-gradient-to-br from-primary/5 to-primary/10"
          >
              ...
              >
                <CardContent className="p-6">
                  <div className="flex items-start gap-4">
                    ...
                    >
                      <prediction.icon
                        className={cn("w-6 h-6", prediction.color)}
                      />
                    </div>
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>
                AI-predicted sales volume for the coming week
              </CardDescription>
            </div>
