...
const aiFeatures = [
  {
    ...
    description:
      "Machine learning algorithms analyze historical data to predict future inventory needs with 95% accuracy.",
  ...
  },
  {
    ...
    description:
      "Automated recommendations for optimal reorder quantities based on sales velocity and lead times.",
  ...
  },
  {
    ...
    description:
      "Real-time warnings for potential drug interactions when processing prescriptions.",
  ...
  },
  {
    ...
    description:
      "24/7 intelligent support for quick answers about inventory, orders, and system operations.",
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-background/70 text-pretty">
            Leverage cutting-edge artificial intelligence to automate decisions,
            predict trends, and enhance patient safety.
          </p>
        </div>
